function [ output_table ] = func_corr_channel_PANSS( input_table, panss_table, conf_table, panss )
...
% variables. Analysis is performed on the level of individual channels.
% 
...
for n = 1:ntest
    ...
    output_struct(n).ch = input_table.ch{n};
    output_struct(n).chID = input_table.chID(n);
    output_struct(n).r = r;
    output_struct(n).p = p;
